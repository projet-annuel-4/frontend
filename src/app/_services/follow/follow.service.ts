...
export class FollowService {
  ...
  follow(idUser1: number, idUser2: number) {
    return this.http.post(
      `${follower_service.BASE_URL}/${idUser1}/follow/${idUser2}`,
      this.httpOptions
    )
  }
  ...
  unfollow(idUser1: number, idUser2: number) {
    return this.http.post(
      `${follower_service.BASE_URL}/${idUser1}/unfollow/${idUser2}`,
      this.httpOptions
    )
  }
  ...
  getAllFollowers(user_id: number): Observable<User[]> {
    return this.http.get<User[]>(
      `${follower_service.BASE_URL}/${user_id}/followers`,
      this.httpOptions
    )
  }
  getAllSubscriptions(user_id: number) {
    return this.http.get<User[]>(
      `${follower_service.BASE_URL}/${user_id}/subscriptions`,
      this.httpOptions
    )
  }
}
