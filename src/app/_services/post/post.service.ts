...
export class PostService {
  ...
  like(post_id: number, user_id: number): Observable<any> {
    return this.http.post(
      `${post_service.BASE_URL}/${post_id}/like/userId/${user_id}`,
      this.httpOptions
    )
  }
  ...
  dislike(post_id: number, user_id: number): Observable<any> {
    return this.http.post(
      `${post_service.BASE_URL}/${post_id}/dislike/userId/${user_id}`,
      this.httpOptions
    )
  }
  ...
  getPostLikedByUser(user_id: number): Observable<Post[]> {
    return this.http.get<Post[]>(
      `${post_service.BASE_URL}/userId/${user_id}/postLiked`,
      this.httpOptions
    )
  }
  ...
  getAllSubscriptionPost(userId: number): Observable<Post[]> {
    return this.http.get<Post[]>(
      `${post_service.BASE_URL}/subscriptions/userId/${userId}`,
      this.httpOptions
    )
  }
  ...
  getAllByFilters(filters: Filters): Observable<Post[]> {
    return this.http.post<Post[]>(
      `${post_service.BASE_URL}/getAllByFilters`,
      filters,
      this.httpOptions
    )
  }
  ...
  getAllUserAnswers(user_id: number): Observable<Post[]> {
    return this.http.get<Post[]>(
      `${post_service.BASE_URL}/user/${user_id}/answers`,
      this.httpOptions
    )
  }
