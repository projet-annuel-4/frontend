...
export class ProjectService {
  ...
  updateProject(projectId: number): Observable<any> {
    return this.http.get<any>(
      `${project_service.BASE_URL}/project/updateProject/${projectId}`,
      this.httpOptions
    )
  }
  ...
  getProjectById(projectId: number): Observable<Project> {
    return this.http.get<Project>(
      `${project_service.BASE_URL}/project/${projectId}/getProjects`,
      this.httpOptions
    )
  }
  ...
  getProjectByIdGroup(groupId: number): Observable<Project[]> {
    return this.http.get<Project[]>(
      `${project_service.BASE_URL}/project/${groupId}/getProjects`,
      this.httpOptions
    )
  }
  ...
  deleteProject(projectId: number, request: UpdateProjectRequest): Observable<Project> {
    return this.http.post<Project>(
      `${project_service.BASE_URL}/project/deleteProject/${projectId}`,
      request,
      this.httpOptions
    )
  }
